...
#[archive(archived = "LtFmIndex")]
pub struct LtFmIndexPreBuild<C: CountArrayConstructor, B: BwtConstructor> {
    text_len: u64,
...
impl<C,B> LtFmIndexConstructor for LtFmIndexPreBuild<C, B> where
...
impl<C, B> LtFmIndexInterface for LtFmIndex<C, B> where
