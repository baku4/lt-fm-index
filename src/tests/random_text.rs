...
const UTF8_OF_NO: [u8; 4] = [b'A', b'C', b'G', b'T'];
const UTF8_OF_NN: [u8; 5] = [b'A', b'C', b'G', b'T', b'_'];
const UTF8_OF_AO: [u8; 20] = [b'A', b'C', b'D', b'E', b'F', b'G', b'H', b'I', b'K', b'L', b'M', b'N', b'P', b'Q', b'R', b'S', b'T', b'V', b'W', b'Y'];
const UTF8_OF_AN: [u8; 21] = [b'A', b'C', b'D', b'E', b'F', b'G', b'H', b'I', b'K', b'L', b'M', b'N', b'P', b'Q', b'R', b'S', b'T', b'V', b'W', b'Y', b'_'];
...
fn rand_text_with_length(chr_list: &[u8], text_len: usize) -> Vec<u8> {
    let mut rng = rand::thread_rng();
