use crate::proto::BwtProto;
use crate::{Deserialize, Serialize, proto};
use crate::{Text, Pattern};

use super::{CountArray, CountArrayProto};
use super::{BwtBlock, POS_BIT_64, POS_BIT_128};
...
pub type Bwt64NN = BwtProto<BwtBlock64NN>;
pub type Bwt128NN = BwtProto<BwtBlock128NN>;
